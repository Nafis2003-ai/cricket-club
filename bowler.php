...
<body class="background">
    ...
    <div class="tab">
        ...
        $sql = 'SELECT * FROM player,bowler WHERE player.player_id=bowler.player_id';
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>" . $row["total_wicket"] . "</td>";
                echo "<td>" . $row["bowling_average"] . "</td>";
                echo "<td>" . $row['economic_rate'] . "</td>";
